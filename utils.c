 ...
 * @size: This is a number indicating the type to be casted.
 *
 * Return: This returns casted value of num
 */
 ...
 * @num: This is a number to be casted
 * @size: This number indicates the type to be casted
 *
 * Return: This returns the casted value of num
 */
