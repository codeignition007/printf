 ...
 * @types: This list the type of arguments to be used
 * @buffer: This is a buffer array to handle print
 * @flags:  This calculates active flags
 * @width: Width
 * @precision: This determines the specified precision
...
/**
 * print_hexa_upper - Prints an unsigned number in upper hexa notation
 * @types: This list the type of arguments to be used
 * @buffer: This is a buffer array to handle print
 * @flags:  This calculates active flags
 * @width: Width
...
/**
 * print_hexadecimal - Function prints an unsigned number in hexa notation
 * @types: This list the type of arguments to be used
 * @buffer: This is a buffer array to handle print
 * @flags:  This calculates active flags
 * @width: Width
 ...
 * @size: This is a size specifier
 * @size: Size specifier
 * Return: This returns the number of char to be printed
 */
